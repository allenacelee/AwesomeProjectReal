 ...
 * @param indicator: false,                           //加载提示框显示标识
 * @param indicatorText: '加载中',                           //加载提示框显示文字
 * =========================================================================
 *
...
export default class NavigationBar extends Component {
    static defaultProps = {
        ...
        indicator: false,//加载提示框显示标识
        indicatorText: '加载中',//加载提示框显示文字
    };
    ...
    render() {
        return (
            <View>
                ...
                <Indicator
                    visible={this.props.indicator}
                    text={this.props.indicatorText}
    ...
    renderLeftView() {
        ...
        return (
            <TouchableOpacity onPress={() => {
                ...
                {/*<Icon name={this.props.leftButtonIcon} size={30} color="white"/>*/}
                <Text style={{color: 'orange', fontSize: 20}}>二</Text>
            </TouchableOpacity>
        )
        //}
    };
